CLASS zbg_gate_entry DEFINITION
  ...
  PUBLIC SECTION.
    ...
    METHODS constructor
      IMPORTING
        ...
        iv_plant type ZI_GATEENTRY_hdr-Plant
  ...
  PROTECTED SECTION.
    ...
    DATA : im_bill TYPE  zde_out_payment,
           ...
           im_plant type ZI_GATEENTRY_hdr-Plant.
...
CLASS ZBG_GATE_ENTRY IMPLEMENTATION.
  ...
  METHOD modify.
    ...
    lo_pfd->get_pdf_64( EXPORTING io_gate = im_bill io_plant = im_plant RECEIVING pdf_64 = DATA(pdf_64) ).


    wa_data-zgate    = im_bill.
    wa_data-plant  = im_plant.
